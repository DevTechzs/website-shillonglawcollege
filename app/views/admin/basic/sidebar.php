...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
        <img src="assets/images/Shillong_Logo.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-dark h5 text-info p-2 ">Shillong Law College</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               <!-- <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="cc_program_add" class="nav-link">
                                <i class="far fa-plus nav-icon text-info"></i>
                                <p>Add</p>
                            </a>
                        </li>
                    </ul>
               ...
               <!-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="admin-url_category_links" class="nav-link">
