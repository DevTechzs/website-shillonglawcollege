<?php
$title = "Research, Publication and Seminar Cell";
    ...
    <div class="">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div id="side-menu">
            <div class="w3-sidebar w3-bar-block w3-light-grey w3-card">
              ...
              <a href="research-publication-seminar-cell" class="w3-bar-item w3-button active">Research, Publication and Seminar Cell</a>
        ...
        <div class="col-sm-9">
          ...
          <div class="welcome">
            <h1 style="text-align:center;">Research, Publication and Seminar Cell</h1>
            <div class="space"></div>
            <p><i>Shillong Law College Research Cell, was established with the purpose of creating a dedicated approach for inculcating and understanding research activities and to ensure that all the law students irrespective of their year of study are equipped with adequate research skills by providing them with the ability to locate, evaluate and use the needed information. This cell further, aim to identify and to invite students and teachers who have passion for research, to join the cell and encourage them in pursuing serious research work. Thus, this cell aims at promoting research among the students and faculties.</i></p>
          </div>
          ...
          <div class="row" style="overflow:auto !important;">
            <div class="col-sm-12">
              <h4 style="text-align:center;">Research, Publication and Seminar Cell Members</h4>
