    ...
    <div class="">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div id="side-menu">
            <div class="w3-sidebar w3-bar-block w3-light-grey w3-card">
              ...
              <a href="environmental-committee" class="w3-bar-item w3-button active">Environmental Committee</a>
        ...
        <div class="col-sm-9">
          ...
          <div class="welcome">
            <h1 style="text-align:center;">Environmental Committee</h1>
            <div class="space"></div>
            <p><i>The Shillong Law College IQAC Environment Committee was formed in the year 2020. The main objectives of this committee is to create environmental awareness, value environmental conservation, understand the environmental, health and social effects of global warming and inculcate environmental discipline amongst students.</i></p>
          </div>
          ...
          <div class="row" style="overflow:auto !important;">
            <div class="col-sm-12">
              <h4 style="text-align:center;">Environmental Committee Members</h4>
              <table class="table tbl-founders">
                ...
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td>Shri. Deba K. N. Kharshiing, Assistant Professor</td>
                    <td>Member</td>
                  </tr>
                  <tr>
                    <td></td>
                    <td>Shri. T. J. Ahmed, Guest Faculty</td>
                    <td>Member</td>
                  </tr>
                  <tr>
                    <td></td>
