    ...
    <div class="">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div id="side-menu">
            <div class="w3-sidebar w3-bar-block w3-light-grey w3-card">
              ...
              <a href="sports-committee" class="w3-bar-item w3-button active">Sports Committee</a>
        ...
        <div class="col-sm-9">
          ...
          <div class="welcome">
            <h1 style="text-align:center;">Sports Committee</h1>
            <div class="space"></div>
            <p><i>The Shillong Law College facilitates for sports and games activities for students both indoor and outdoor. It encouraged the students to participate in institutional sports events, it also makes sure of the smooth conduct of the sports and games within the college. The main objective for the sport committee is to promote students’ interest to organize an intra sport competition within the State. </i></p>
          </div>
          ...
          <div class="row" style="overflow:auto !important;">
            <div class="col-sm-12">
              <h4 style="text-align:center;">Sports Committee Members</h4>
              <table class="table tbl-founders">
                ...
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td>Smti. Lakyntiew N. Khyriem, Assistant Professor</td>
                    <td>Member</td>
                  </tr>
                  <tr>
                    <td></td>
