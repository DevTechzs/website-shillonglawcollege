    ...
    <div class="">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div id="side-menu">
            <div class="w3-sidebar w3-bar-block w3-light-grey w3-card">
              ...
              <a href="alumini-committee" class="w3-bar-item w3-button active">Alumini Committee</a>
        ...
        <div class="col-sm-9">
          ...
          <div class="welcome">
            <h1 style="text-align:center;">Alumini Committee</h1>
            <div class="space"></div>
            <p><i>The Shillong Law College Alumni Committee shall consist of Law graduates or, more broadly, of former students (alumni). The main purposes of the Shillong Law College Alumni Association are to support a network of former law graduate who will in turn, help to raise the profile of the College. Its main aims to promote, maintained and preserved friendship among all alumni who had successfully completed their LL. B degree from the Shillong Law College. It also aims to arrange periodic get together of its members with a view to promote social, cultural and sports activities among them. It shall also render assistance to students of the Shillong Law College through scholarships and awards.</i></p>
          </div>
          ...
          <div class="row" style="overflow:auto !important;">
            <div class="col-sm-12">
              <h4 style="text-align:center;">Alumini Committee Members</h4>
