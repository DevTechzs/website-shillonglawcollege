...
class Email
{
	...
	{
		$sender = 'no-reply@Don Bosco Technical.com';
		$organisation = 'Don Bosco Technical';
		...
		$query = "INSERT INTO EmailDetails(Description, EmailID, Subject) VALUES (:Description,:EmailID,:Subject);";
																						...
																						<tbody>
																							<tr>
																								<td valign="top" style="text-align:center;word-break:break-word;color:#656565;font-family:Helvetica;font-size:12px;line-height:150%;padding:0px 18px 9px" align="center">
																									<img align="left" alt="'.$organisation.'" height="100" width="100px" src="https://Don Bosco Technical.in/assets/logo.png" style="height:auto!important;padding-left:14px;outline:none;text-decoration:none;margin:0px;border:0px;" title="'.$organisation.'" class="CToWUd">
																								</td>
																								<td>
